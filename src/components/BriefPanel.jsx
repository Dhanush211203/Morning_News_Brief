...
const BriefPanel = ({ isMobile }) => {
  ...
  return (
    <div className={`
      ...
      ${isMobile 
        ? 'w-full rounded-t-3xl max-h-[80vh] min-h-[40vh] p-4 sm:p-6' 
    ...
    `}>
      ...
      <div className="flex items-center space-x-3 mb-8">
        ...
        <div>
          <h2 className="text-xl font-bold text-slate-900 dark:text-white leading-tight">Your Morning Brief</h2>
          <p className="text-sm text-slate-500 dark:text-slate-400">AI-powered 60s summary</p>
        </div>
      </div>
      ...
      <button
        ...
        className={`
          w-full py-4 px-6 rounded-xl font-bold text-lg text-white transition-all duration-300 flex items-center justify-center space-x-2
        ...
        `}
      >
        <span>{isGenerating ? 'Analyzing Headlines...' : 'Generate My Brief'}</span>
        {!isGenerating && (
      ...
      {/* Brief Display Area */}
      <div className="pt-8 flex-1 overflow-y-auto min-h-[200px]">
        {isGenerating ? (
          <div className="flex flex-col items-center justify-center p-8 space-y-4">
            ...
            <p className="text-slate-500 dark:text-slate-400 font-medium animate-pulse">
              Gemini is composing your brief...
            </p>
          </div>
        ) : displayedText ? (
          ...
          <div className="h-full flex flex-col items-center justify-center p-8 text-center text-slate-500 dark:text-slate-400 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-dashed border-slate-200 dark:border-slate-700">
            ...
            <p className="font-medium">Select up to 3 topics to begin.</p>
          </div>
        ) : null}
      </div>
    </div>
